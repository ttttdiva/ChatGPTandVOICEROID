...
class LLMManager:
    def __init__(self, ai_character, ai_dialogues, model="gpt-3.5-turbo", ai_name="AI"):
        ...
        # 固定プロンプトを入力
        self.conversation.prompt = self.create_prompt_template(ai_character + ai_dialogues)
        self.previous_summary = ""

    def create_prompt_template(self, ai_character):
        return ChatPromptTemplate.from_messages([
            SystemMessagePromptTemplate.from_template(ai_character),
